...
- **Launched a new self-serve content moderation platform**, improving user flows and service design for social media managers, moderators, and client success through better UX and increased automation.
- **Secured strategic partnership for R&D initiative with a major music label**, while leading cross-functionally across design and technology.
- **Secured two successful funding rounds**, leading stakeholders’ strategic alignment and creation of board and investors’ materials.
- **Won their biggest international client to date** through growth initiatives across marketing, sales and client success.
...
With a small team and limited budget, I **led user research, competitor analysis, and signal scanning** to inform product and design decisions, with a focus on emotion-based AI and the societal impact of online ecosystems and emerging technologies. Combined with client insights from our Client Success and Sales teams, this helped us define key user types and their needs.
...
Working with a creative agency, I led the brand transition from GoBubble to Freedom2hear, including a new **creative direction for the marketing website and sales assets.**

![Marketing Website](/case-studies/freedom2hear/website.png)

To streamline our design work and ensure consistency, I created a **design system** with shared foundations across product and marketing, and a focus on accessibility.

![Figma & Webflow Sync](/case-studies/freedom2hear/variables.png)

### New Product Demo

I led the design and build of a **new product demo experience in Webflow**.
